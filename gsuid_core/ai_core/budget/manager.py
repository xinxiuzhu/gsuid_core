...
class BudgetManager:
    ...
    async def load_from_db(self) -> None:
        ...
        async with self._persist_lock:
            ...
            self._loaded = True
        logger.info(t("log.ai.budget_reloaded_usage_ledger_load", p0=len(loaded)))
        ...
        async with self._persist_lock:
            ...
            if dirty:
                ...
                if ok:
                    ...
                    logger.warning(t("log.ai.budget_usage_persisted_db_fail", p0=len(dirty)))
    ...
    async def reset_scope(
        ...
        async with self._persist_lock:
            ...
            try:
                ...
                logger.warning(t("log.ai.budget_delete_db_transactions_fail", e=e))
        return removed
